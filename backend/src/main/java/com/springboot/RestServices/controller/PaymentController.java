...
import com.springboot.RestServices.response.ApiResponse;
import com.springboot.RestServices.response.PaymentLinkResponse;
import com.springboot.RestServices.exception.CartItemException;
import com.springboot.RestServices.exception.OrderException;
...
import com.springboot.RestServices.model.Order;
import com.springboot.RestServices.model.User;
import com.springboot.RestServices.repository.OrderRepository;
import com.springboot.RestServices.service.CartItemService;
import com.springboot.RestServices.service.CartService;
import com.springboot.RestServices.service.OrderService;
import com.springboot.RestServices.service.UserService;
import com.springboot.RestServices.user.domain.OrderStatus;
import com.springboot.RestServices.user.domain.PaymentStatus;
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("http://localhost:5173/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
